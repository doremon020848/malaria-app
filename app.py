...
if img:
    ...
    if st.button("START ANALYTICS"):
        ...
        <div class="result-display">
            ...
            <h2 style="font-family:Orbitron; color:{color}; margin:0; letter-spacing:10px;">{status}</h2>
            ...
            <h1 style="font-family:Orbitron; font-size:1.5rem; margin:0;">{conf*100:.2f}%</h1>
        </div>
        """, unsafe_allow_html=True)
